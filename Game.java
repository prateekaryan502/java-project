...
public class Game {
    ...
    public ArrayList<Render> getRenders() {
        ...
        renders.add(new Render(0, 0, "out/lib/background.png"));
        for (Pipe pipe : pipes)
            renders.add(pipe.getRender());
        renders.add(new Render(0, 0, "out/lib/foreground.png"));
